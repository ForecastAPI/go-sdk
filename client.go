...
// APIClient manages communication with the ForecastAPI API v2.2.0
...
type APIClient struct {
	...
	GroupedForecastingAPI *GroupedForecastingAPIService

	HealthAPI *HealthAPIService

	InventoryPlanningAPI *InventoryPlanningAPIService

	ProductInsightsAPI *ProductInsightsAPIService

	TrafficForecastingAPI *TrafficForecastingAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.InventoryPlanningAPI = (*InventoryPlanningAPIService)(&c.common)
	c.ProductInsightsAPI = (*ProductInsightsAPIService)(&c.common)
	c.TrafficForecastingAPI = (*TrafficForecastingAPIService)(&c.common)
